...
def face_align(image_path, merge_result=False, image_size=224):
...
if __name__ == '__main__':
	...
	if args.need_align:
		...
		face_align(args.source_img_path)
		face_align(args.target_img_path, args.merge_result, args.image_size)
